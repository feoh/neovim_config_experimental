return {
  ...
  keys= {
    ...
    { "<leader>ss", function() Snacks.picker.lsp_symbols() end, desc = "[L]SP [S]ymbols" },
    { "<leader>sS", function() Snacks.picker.lsp_workspace_symbols() end, desc = "[L]SP [W]orkspace Symbols" },
  },
}
